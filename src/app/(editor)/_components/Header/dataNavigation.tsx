...
const dataNavigation:IMenuItem[] = [
  {
    id: "css",
    name: "CSS",
    url: "css",
    icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-full w-full" viewBox="0 0 342 480" version="1.1">
      <g id="#0170baff">
